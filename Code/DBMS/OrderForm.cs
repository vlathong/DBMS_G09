...
namespace DBMS
{
    public partial class OrderForm : Form
    {
        ...
        {
            using (SqlConnection connection = new SqlConnection(@"Data Source=LAPTOP-EG3I3875\SQLSERVERMS;Initial Catalog=DBMS_ThucHanh_Nhom15;Integrated Security=True"))
            {
                try
                {
                    connection.Open();
