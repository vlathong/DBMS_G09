...
namespace DBMS
{
    public partial class DriverForm : Form
    {
        ...
        string str = @"Data Source=LAPTOP-EG3I3875\SQLSERVERMS;Initial Catalog=DBMS_ThucHanh_Nhom15;Integrated Security=True";
        string placeholder = "Enter citizen ID...";
        string oldBank = "";
        string oldNum = "";
        string oldIDNum = "";
        string oldPhone = "";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult confirm = MessageBox.Show("Confirm this driver fix?", "Fix", MessageBoxButtons.YesNo);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult confirm = MessageBox.Show("Further confirmation of this driver's information?", "Further confirmation", MessageBoxButtons.YesNo);
                if (confirm == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        loadAfterAdd();
                        MessageBox.Show("Driver information has been successfully added.");
                    }
                    catch (Exception ex)
                    {
            ...
            {
                MessageBox.Show("The driver already exists.");
            }
        }
