...
namespace DBMS
{
    public partial class CustomerForm : Form
    {
        ...
        string placeholder = "Input your telephone number...";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(str))
            {
                try
                {
                    ...
                    {
                        DialogResult confirm = MessageBox.Show("Confirm this customer fix?", "Fix", MessageBoxButtons.YesNo);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        reader.Close();
                        DialogResult confirm = MessageBox.Show("Further confirmation of this customer's information?", "Further confirmation", MessageBoxButtons.YesNo);
                        if (confirm == DialogResult.Yes)
                        {
                            //connection.Open();
                            ...
                            autoLoadData();
                            MessageBox.Show("Customer information has been successfully added.");
                            loadAfterAdd();
                        }
                    }
                    else
