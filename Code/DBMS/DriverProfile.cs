...
namespace DBMS
{
    public partial class DriverProfile : Form
    {
        ...
        private void loadData()
        {
            ...
            {
                phiThueChan.Text = "No deposit fee has been paid.";//thế chân
            }
            else
            {
                phiThueChan.Text = "Deposit fee has been paid.";
            }
        ...
        private void saveData()
        {
            ...
            {
                DialogResult confirm = MessageBox.Show("Confirm this fix?", "Fix", MessageBoxButtons.YesNo);
