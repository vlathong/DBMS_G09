...
go
----------------------------------------------
-- Transaction 1:  Nhân viên giảm giá cho các sản phẩm được cung cấp bởi chi nhánh 
alter procedure NV_giamgia_SP2
	@MaCN nvarchar(10),
	@GiaGiam int
as
begin tran 
...
-- Transaction 2: Khách hàng xem các sản phẩm được cung cấp bởi chi nhánh 
alter procedure XemSP_CuaCN2
	@MaCN nvarchar(10)
as
begin tran
