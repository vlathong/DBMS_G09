...
go
-------------------------------------------------------------
--Transaction 1: Nhân viên xem danh sách các hợp đồng có ngày bắt đầu trễ hơn 05/08/2020. (n hợp đồng)
alter procedure Xem_DanhSachHD2
	@NgayBD datetime
as
begin tran 
...
--Transaction 2: Nhân viên thêm một hợp đồng có ngày bắt đầu là 06/08/2020
create procedure NV_themHD2
    @MaDT nvarchar(10),
